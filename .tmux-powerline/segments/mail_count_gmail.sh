...
username="jenner"		# Enter your Gmail username here WITH OUT @gmail.com.( OR @domain )
password=""		# Leave this empty to get password from keychain.
server="edgetechsd.com"	# Domain name that will complete your email. For normal GMail users it probably is "gmail.com but can be "foo.tld" for Google Apps users.
