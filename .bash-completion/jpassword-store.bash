...
_jpass_complete_entries () {
	prefix="${PASSWORD_STORE_DIR:-$HOME/Dropbox/.password-store/}"
	suffix=".gpg"
	autoexpand=${1:-0}
...
complete -o filenames -o nospace -F _jpass jpass
